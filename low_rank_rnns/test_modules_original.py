# For test purpose: original full rank RNN from modules.py. Then we found 
# if initialize wi with normal and divided by sqrt of (size of #units) 
# choice will be more represented 
...
def train(net, _input, _target, _mask, n_epochs, lr=1e-2, batch_size=32, plot_learning_curve=False, plot_gradient=False,
          clip_gradient=None, early_stop=None, keep_best=False, cuda=False, resample=False,
          initial_states=None):
    """
    Train a network
    :param net: nn.Module
